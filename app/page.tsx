...
export default function Home() {
  ...
  return (
    <>
      ...
      <InfoRow id="digitale-ervaring" description="Met Jouw Erfgoedpaspoort kun je op een unieke manier kennismaken met het rijke culturele erfgoed in jouw omgeving. Verzamel herinneringen, ontdek verhalen en bouw je eigen digitale collectie op van bijzondere plekken en objecten die ons verleden vertellen." />
      <DigitalHeritageRow />
      <InfoRow
        id="dienstverlening"
